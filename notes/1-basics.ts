...
//ie a variable that takes on a different value based off a condition, ie case switch with 5 or 6 clauses
//declared the variable outside the switch statement and then assign it
let z;
z = 41;
...
bb.push(1, 2, 2, 2, 2); //works, no type safety with push
